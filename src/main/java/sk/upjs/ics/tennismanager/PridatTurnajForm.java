...
public class PridatTurnajForm extends javax.swing.JFrame {

    public PridatTurnajForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PridatTurnajForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PridatTurnajForm().setVisible(true);
            }
        });
    }
